    ...
    switch (status) {
      case AccountStatus.active:
        return StatusConfig(
          ...
          secondaryColor: const Color.fromARGB(255, 30, 233, 165),
          features: [
            'وصول كامل إلى جميع المزايا وفقًا لنوع حسابك',
            'إدارة المنتجات والمخزون بكفاءة عالية (لمالك المتجر)',
            'استقبال الإشعارات والتنبيهات الفورية',
            'دعم فني متواصل لضمان أفضل تجربة استخدام',
          ],
        );
